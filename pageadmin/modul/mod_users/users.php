...
switch($_GET[act]){
  ...
  default:
    ...
    echo " <div class='col-md-12'>
			<div class='card'>
				<div class='header'>
					<center><h3 class='title'><b>HALAMAN ADMIN</b></center></h3>
				</div>
                <div class='content'>
    ...
    echo "							<tr>
										...
										<td>$r[no_telp]</td>
										<td center>$r[blokir]</td>
										<td><a href='?module=user&act=edituser&id=$r[id_session]'><i class='pe-7s-diskette'>Edit</i></a>
									</tr>";                                       
	$no++;
    }
    echo "							</tbody>
  ...
  case "tambahuser":
    ...
    echo " <div class='col-md-12'>
            <div class='card'>
                <div class='header'>
					<header><h4>TAMBAHKAN USER</h4></header>
				</div>
                <div class='content'>
        ...
        <tr><td colspan=1><input type=submit class=button value=Simpan>
  ...
  case "edituser":
	...
	<div class='col-md-12'>
	 ...
	 <header><h3>EDIT USER</h3></header>
          ...
          <div class='module_content'>
          <table id='rounded-corner'>
          <tr><td>Username</td>     <td> : <input type=text name='username' size=30 value='$r[username]'></td></tr>
